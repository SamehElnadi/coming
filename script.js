...
const quranTable = [
  ...
  { verse: "أياما معدودات ۚ فمن كان منكم مريضا أو على سفر فعدة من أيام أخرى وعلى الذين يطيقونه فدية طعام مسكين ۖ فمن تطوع خيرا فهو خير له وأن تصوموا خير لكم إن كنتم تعلمون" },
